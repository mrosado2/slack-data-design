...
<html lang="en">
	...
	<body>
		...
		<main><h3>User</h3>
				<p>
					Gloria will be using Slack Direct Messange with her school peers and professors for ongoing project colaboration.
				</p>
				<ul>
					...
					<p>Gloria decided to go back to school to continue her Photography studies sinced she wants to change careers from
						...
						<p>She wants to make the most out of the time in school to learn as much as possible from the experience of
							the professors and her peers, as she wants to become an excellent photographer. </p>
						...
						to use the same app to cummunicate with her sister and other collaborators for her business needs, by creating her own team
							in Slack.</p>
				<h3>Use Case</h3>
				<p><strong>Goal:</strong> Gloria wants to become very effective at her communication with Slack. She has commited
					to use it as much as possible to maximaze her learning while in school and to ensure the use of this app will be convinient
					for her business.</p>
			<ol>
